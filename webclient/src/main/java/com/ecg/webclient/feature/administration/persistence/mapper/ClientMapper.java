...
public class ClientMapper
{
	...
	@Autowired
	public ClientMapper(ClientRepository clientRepo)
	{
	...
	/**
	 * Wandelt eine Liste von attachten Mandanten in eine Liste von detachten
	 * Mandanten um.
	 * 
	 * @param clients
	...
	/**
	 * Wandelt eine Liste von detachten Mandanten in eine Liste von attachten
	 * Mandanten um.
	 * 
	 * @param dtos
