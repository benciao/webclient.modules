...
public class GroupMapper
{
	...
	@Autowired
	public GroupMapper(ClientMapper clientMapper, RoleRepository roleRepo, GroupRepository groupRepo)
	{
	...
	/**
	 * Wandelt eine Liste von attachten Gruppen in eine Liste von detachten
	 * Gruppen um.
	 * 
	 * @param groups
	...
	/**
	 * Wandelt eine Liste von detachten Gruppen in eine Liste von attachten
	 * Gruppen um.
	 * 
	 * @param dtos
